...
Used the function Na to remove the NA data - need to check if done.
Want to exclude gender and also state as not relevan to the quesetions we we are being asked
